...
export function resolveChineseSimplified(text: Label): string {
    switch (text) {
        ...
        case Label.ThemeDescription:
            return "决定是跟随系统主题，还是强制使用浅色或深色模式。";
        ...
        case Label.FrameRateDescription:
            return "确定计时器显示的帧率。“电池感知”会尝试根据设备类型和充电状态选择合适的帧率。“匹配屏幕”使计时器与屏幕刷新率一致。";
        ...
        case Label.AboutDescription:
            return "LiveSplit One 是 LiveSplit 的跨平台版本，是为速通玩家打造的简洁且高度可定制的计时器。";
        case Label.AboutViewSource:
            return "在 GitHub 上查看源代码";
        ...
        case Label.CustomVariableTooltip:
            return "你自定义的变量，可用于文本组件显示。";
        case Label.NoVariables:
            return "当前没有此游戏的自定义变量。";
        case Label.NoVariablesWithSpeedrunCom:
            return "当前没有 speedrun.com 变量或自定义变量。";
        ...
        case Label.RowDescription:
            return "一行水平排列的组件，改变内部组件的布局方向。";
        case Label.Column:
            return "列";
        case Label.ColumnDescription:
            return "一列垂直排列的组件，改变内部组件的布局方向。";
        ...
        case Label.CustomVariableNoneAvailableTooltip:
            return "可在编辑分段时的变量标签页中定义自定义变量。自动分段器也可自动提供额外的自定义变量。";
        case Label.HotkeyButtonTooltip:
            return "点击以录制热键。也可以使用手柄按钮。全局热键目前不可用。手柄按钮可全局使用。";
        ...
        case Label.ConnectToServerDescription:
            return "指定 WebSocket URL：";
        case Label.Connect:
            return "连接";
        case Label.UpdateAvailable:
            return "LiveSplit One 有新版本可用！点击此处重新加载。";
        case Label.UnsavedChangesBeforeUnload:
            return "有未保存的更改。确定要关闭 LiveSplit One 吗？";
        ...
        case Label.LayoutCouldNotBeLoaded:
            return "无法加载布局。这可能不是有效的 LiveSplit 或 LiveSplit One 布局。";
        ...
        case Label.BugReportInstructions:
            return "为帮助我们修复此问题，请提供复现步骤，并附上问题发生时你使用的分段和布局。";
